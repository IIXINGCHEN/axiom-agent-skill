...
>
> **源↔蒸馏关系**：本目录（skills/axiom/references/）是 v21.2 蒸馏版；`commands/axiom/`（config/foundation/modes/cognitive/protocols/standards，v20.0）是源模块库，经 `/axiom:view <module>` 访问。两者是同一套 axiom 教条的两种形态，非字节重复；版本漂移（源 v20.0 / 蒸馏 v21.2）为已知项。
